...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_path", type=str, default="./save_para1/kaggle/")
    ...
    parser.add_argument("--testing_path", type=str, default="/home/utl/PycharmProjects/Calligraphic-Images-Denoising-by-GAN/TestingData/test/1.png")
